<form class="form-horizontal" id="form" role="form" method="post" action="{{ url('page/clientes/endereco/editar/save') }}/{{ $id }}" enctype="multipart/form-data" >
	@csrf
	<div class="conteudo-login" style="padding: 0rem 0 0.5rem 0">
		<div class="bloco1">
			<div class="group-register" style="width:30%;">
				<div class="group">      
                    <input type="text" name="cep" id="cep" class="cep" value="{{ $cep }}" onkeypress="return isNumber(event)" required autocomplete="off">
					<span class="highlight"></span>
					<span class="bar"></span>
					<label>Cep</label>
				</div>
			</div>
			<div class="group-register" style="width:64%;">
				<div class="group">      
					<input type="text" name="complemento" id="complemento" class="complemento" value="{{ $complemento }}" required autocomplete="off">
					<span class="highlight"></span>
					<span class="bar"></span>
		...
		<div class="bloco1">
			 <div class="group-register" style="width:72%;">
				<div class="group">      
					<input type="text" name="bairro" id="bairro" class="bairro" value="{{ $bairro }}" required autocomplete="off">
					<span class="highlight"></span>
					<span class="bar"></span>
					<label>Bairro</label>
				</div>
			</div>
			<div class="group-register" style="width:24%;">
				<div class="group">      
					<input type="text" name="numero" id="numero" class="numero" value="{{ $numero }}" onkeypress="return isNumber(event)" required autocomplete="off">
					<span class="highlight"></span>
					<span class="bar"></span>
					<label>Numero</label>
				</div>
		...
		<div class="bloco1">
			 <div class="group-register" style="width:48%;">
				<div class="group">
                    <select id="estado" name="estado" onchange="buscaCidades(this.value)">
						...
						<option value="RR" {{ ($estado == "PR") ? "selected" : "" }}>Roraima</option>
			...
			<div class="group-register" style="width:48%;">
				<div class="group">      
					<select id="cidade" name="cidade">
                        <option value="{{ $cidade }}" {{ ($cidade == $cidade) ? "selected" : "" }}>{{ $cidade }}</option>
                    </select>
				</div>
			</div>	
		</div>
		<div class="group-register" style="width:100%;">
			<div class="group">      
				<input type="text" name="endereco" id="endereco" class="endereco" value="{{ $endereco }}" required autocomplete="off">
				<span class="highlight"></span>
				<span class="bar"></span>
...
function buscaCidades(e){
   ...
   if(j_index != -1){
      ...
      json_cidades.estados[j_index].cidades.forEach(function(cidade){
         ...
         cid_opts.setAttribute('selected',cidade)
