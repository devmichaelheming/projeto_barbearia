...
<head>
    ...
    <title>BARBER EASY - CLIENTES</title>
    {{-- LINKS CSS --}}
    ...
    <div class="container-geral">
        ...
        <div class="body-container">
            ...
            <div class="title-body">
                <span>
                    Informação dos clientes cadastrados no sistema
                </span>
                <a href="{{ url('/admin/clientes/viewCadastrar') }}" class="button-cadastrar btn-cadastrar">
                    <span>Cadastrar</span>
                </a>
            </div>
                ...
                <tbody>
                    @for ($i = 0; $i < sizeof($clientes); $i++)
                        <tr>
                            ...
                            <td>{{ date( 'd/m/Y - H:i' , strtotime($clientes[$i]['created_at'])) }}</td>
                            @endisset

                            <td>
                                <div class="botoes">
                                    <a href="{{ url('admin/clientes/editar') }}/{{ $clientes[$i]['id'] }}" class="botao-editar btn-editar" style="margin-right: 10px;">
                                        <span class="entypo-tools"><i class="fas fa-edit"></i></span>
                                    </a>
                                    <button type="button" class="editar btn-confirm" data-id="{{ url('admin/clientes/confirm') }}/{{ $clientes[$i]['id'] }}">
